...
request("http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&api_key=4805952fc67479eac7e65e3dff46536f&format=json",function(er,re,body){
...
app.get("/all",isLoggedIn,function(req,res){
	var data;
	request("http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&api_key=4805952fc67479eac7e65e3dff46536f&format=json",function(er,response,body){
		if(!er&&res.statusCode==200){
...
app.get("/results",isLoggedIn,function(req,res){
	...
	var song = "http://ws.audioscrobbler.com/2.0/?method=track.search&track="+song1+"&api_key=4805952fc67479eac7e65e3dff46536f&format=json";
	var name;
	var url;
